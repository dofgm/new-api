...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/xunhu/webhook", anonymousRequestBodyLimit, controller.XunhuWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/access-token", controller.GetOrCreateAccessToken)
				...
				selfRoute.GET("/xunhu/order_status", controller.GetXunhuOrderStatus)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			// CUSTOM: admin 修改订阅期限
			subscriptionAdminRoute.PATCH("/user_subscriptions/:id/end_time", controller.AdminUpdateUserSubscriptionEndTime)
		}

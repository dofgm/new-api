...
export function PaymentSettingsSection({
  ...
  const onSubmit = async (values: PaymentFormValues) => {
    const sanitized = {
      ...
      XunhuApiUrl:
        values.XunhuApiUrl.trim() || 'https://api.xunhupay.com/payment/do.html',
    ...
    if (sanitized.XunhuOrderExpire !== initial.XunhuOrderExpire) {
      updates.push({
        ...
        value: sanitized.XunhuOrderExpire,
      })
    }
          ...
          <Tabs defaultValue='general' className='min-w-0'>
            <div className='overflow-x-auto pb-1'>
              <TabsList className='grid min-w-[52rem] grid-cols-7'>
                ...
                <TabsTrigger value='xunhu'>Xunhu</TabsTrigger>
              </TabsList>
            </div>
            ...
            <TabsContent value='xunhu' className={paymentTabContentClassName}>
              <XunhuSettingsSection
                values={xunhuValues}
